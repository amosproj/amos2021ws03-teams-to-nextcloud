    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
      <div class="modal-content container-fluid" @click.stop="">
        <div class="modal-header">
          <h5 class="modal-title font-weight-bold">Rename</h5>
          <button type="button"
                  class="close"
                  id="closeButton"
                  data-toggle="tooltip"
        ...
        <div class="modal-footer">
          <button type="button" class="btn font-weight-bold" id="saveButton" @click="rename">
            Save
          </button>
    ...
    methods: {
      ...
      rename() {
        ...
        if (itemNameWithFormat !== selectedItem.name) {
          ...
          this.$store.dispatch("rename", { currentPath: selectedItem.path,
      ...
      close() {
        this.$store.commit("setIsRenameModalVisible", false);
